...
interface TaskDef { id: string; icon: IconName; title: string; subtitle: string; to: string; done: boolean; show: boolean }
...
export function FinishSetup() {
  ...
  const defs: TaskDef[] = [
    { id: 'cards', icon: 'plus', title: 'Add payment cards', subtitle: 'Group your spending by card.', to: '/william/account/cards', done: cardsCount > 0, show: true },
    { id: 'fire', icon: 'target', title: 'Set your FIRE goal', subtitle: 'Track your progress to independence.', to: '/william/fire', done: fireAnnualExpenses != null || fireTarget != null, show: true },
    { id: 'import', icon: 'import', title: 'Import your holdings', subtitle: "From your broker's Excel.", to: '/william/portfolio', done: false, show: portfolioMode === 'detailed' && trades === 0 },
    { id: 'sync', icon: 'refresh', title: 'Sync your devices', subtitle: 'Access on your phone and laptop.', to: '/william/account/sync', done: false, show: true },
  ];
